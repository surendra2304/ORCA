...
export const FishermanLayout: React.FC = () => {
  ...
  const isVoiceGuide = location.pathname === '/fisherman/voice';
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 flex flex-col antialiased select-none">
      ...
      {!isVoiceGuide && <div className="w-full bg-white border-b border-slate-100 px-4 py-2.5 flex items-center justify-between sm:px-6">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <span className="hidden text-[10px] text-[#20B2AA] font-semibold ml-2 px-2 py-0.5 rounded-full bg-[#e0f5f4] sm:inline">
