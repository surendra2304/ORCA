...
export const FishermanVoicePage: React.FC = () => {
  ...
  return (
    <div className="min-h-svh bg-white flex flex-col items-center justify-between p-4 sm:p-10 select-none">
      ...
      <div className="w-full max-w-xl my-auto py-4 sm:py-6 flex flex-col items-center text-center">
        
        {/* Animated Microphone Graphic */}
          <div className="relative inline-flex items-center justify-center my-3 sm:my-4">
          {isListening && (
            <>
          ...
          <button
            ...
            className="relative z-10 w-18 h-18 sm:w-20 sm:h-20 rounded-full bg-[#20B2AA] text-white flex items-center justify-center shadow-xl hover:bg-[#1a9e97] transition-all"
          >
        ...
        <div className="min-h-[56px] sm:min-h-[64px] flex items-center justify-center mb-4 sm:mb-6 px-2 sm:px-4">
        ...
        <div className="w-full bg-slate-50 p-3 sm:p-4 rounded-2xl border border-slate-200 text-left mb-4 sm:mb-5 shadow-xs">
          {currentStep === 0 && (
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {COASTAL_REGIONS.map(reg => (
                  <button
                    ...
                    className="min-h-11 px-3 py-2.5 text-xs font-semibold text-slate-800 bg-white hover:bg-[#e0f5f4] hover:text-[#20B2AA] hover:border-[#20B2AA] rounded-xl border border-slate-200 transition-all text-left shadow-2xs"
                  >
                    {reg.name}
                  </button>
                ))}
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="min-h-11 px-3.5 py-2.5 text-xs font-semibold text-slate-800 bg-white hover:bg-[#e0f5f4] hover:text-[#20B2AA] hover:border-[#20B2AA] rounded-xl border border-slate-200 transition-all shadow-2xs"
                  >
                    {item.label}
                  </button>
                ))}
              ...
              <div className="flex flex-wrap gap-2">
                {['04:00 AM', '05:30 AM', '07:00 AM', '16:00 PM'].map(tm => (
                  <button
                    ...
                    className="min-h-11 px-4 py-2.5 text-xs font-semibold text-slate-800 bg-white hover:bg-[#e0f5f4] hover:text-[#20B2AA] hover:border-[#20B2AA] rounded-xl border border-slate-200 transition-all shadow-2xs"
                  >
                    {tm}
                  </button>
                ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <button
                    ...
                    className="min-h-11 px-3.5 py-2.5 text-xs font-semibold text-slate-800 bg-white hover:bg-[#e0f5f4] hover:text-[#20B2AA] hover:border-[#20B2AA] rounded-xl border border-slate-200 transition-all text-left shadow-2xs"
                  >
                    {p.label}
                  </button>
                ))}
