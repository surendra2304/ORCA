...
export const Page6Productivity: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 sm:py-5 space-y-4 sm:space-y-6 select-none">
      {/* Page Header Banner */}
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
        <div className="min-w-0">
          <div className="flex flex-col items-start gap-1.5 sm:flex-row sm:items-center sm:space-x-2 sm:gap-0">
        ...
        {/* Overall Score Badge */}
        <div className="w-full sm:w-auto bg-[#e0f5f4] p-3 rounded-xl border border-[#20B2AA]/30 flex items-center space-x-3 self-start md:self-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
        ...
        <div className="lg:col-span-7 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3 sm:space-y-4">
          ...
          <div className="p-3 rounded-xl bg-[#e0f5f4] border border-[#20B2AA]/20 text-xs flex items-start space-x-3">
            ...
            <p className="hidden sm:block text-slate-700 text-[11px] leading-relaxed">
        ...
        <div className="lg:col-span-5 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2">
            {TOP_NATIONAL_PRODUCTIVITY_ZONES.map(item => (
              ...
              >
                ...
                <div className="hidden sm:grid grid-cols-2 gap-1 text-[11px] text-slate-500 mt-1 pl-7">
                  <div><strong>Region:</strong> {item.region}</div>
                  <div><strong>{t.catchForecast}:</strong> {item.catchForecast}</div>
                </div>

                <div className="hidden sm:block text-[10px] text-slate-600 pl-7 mt-1">
      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3">
        ...
        <MarineMap
          ...
          customHeight="h-[360px] sm:h-[460px]"
        />
      </div>
    </div>
  );
