...
export const OthersHomePage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 sm:py-5 space-y-4 sm:space-y-6 select-none">
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
        <div>
        ...
        <div className="w-full sm:w-auto flex items-center space-x-2 self-start md:self-auto bg-slate-50 p-1.5 rounded-xl border border-slate-200">
          ...
          <select
            ...
            className="min-w-0 flex-1 sm:flex-none px-2.5 py-1 text-xs font-bold text-slate-700 bg-transparent border-none focus:outline-hidden"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-3">
          ...
          <MarineMap
            ...
            customHeight="h-[360px] sm:h-[500px]"
          />
        </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-[#e0f5f4] p-3 sm:p-4 rounded-2xl border border-[#20B2AA]/20 text-xs space-y-2">
