...
import { RouteOptimizationPage } from './pages/others/RouteOptimizationPage';
  ...
  return (
    <AppProvider>
      <BrowserRouter>
        <Routes>
          {/* ================= 1. ONBOARDING FLOW ================= */}
          {/* Page 1: Welcome Screen with Role Selection */}
          <Route path="/" element={<Page1Welcome />} />

          {/* Page 2: Global Language Selection & Profile Name */}
          <Route path="/language" element={<Page2Language />} />

          {/* Legacy / Direct fallback for user-details */}
          <Route path="/user-details" element={<Navigate to="/language" replace />} />
          ...
          <Route path="/others" element={<OthersLayout />}>
            ...
            {/* Others Page: Route Optimization & Voyage Planning */}
            ...
            {/* Others Page: Settings & System Preferences */}
          ...
          <Route path="/route-optimization" element={<Navigate to="/others/route-optimization" replace />} />
          ...
          <Route path="/settings" element={<Navigate to="/others/settings" replace />} />
