...
class ORCAState(TypedDict, total=False):
    ...
    reflection: Optional[Dict[str, Any]]       # Bounded reflection output
    replan: Optional[Dict[str, Any]]           # Replan trace output
    replan_execution_plan: Optional[List[List[str]]] # Replan execution batches
    final_answer: str
