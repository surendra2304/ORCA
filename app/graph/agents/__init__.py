...
from app.graph.agents.route import agent as route_agent
...
# Single source of truth for all valid agents across ORCA
VALID_AGENTS: Set[str] = set(AGENT_REGISTRY.keys())
